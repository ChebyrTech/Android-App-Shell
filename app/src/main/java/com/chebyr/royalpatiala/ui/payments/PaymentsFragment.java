 ...
 */
public class PaymentsFragment extends Fragment implements PaymentsAdapter.OnClickListener
{
                             ...
                             Bundle savedInstanceState)
    {
        ...
        paymentListView = (RecyclerView)rootView.findViewById(R.id.payment_list);
        LinearLayoutManager layoutManager = new LinearLayoutManager(context, LinearLayoutManager.VERTICAL, false);
        paymentListView.setLayoutManager(layoutManager);

        ArrayList<String> contactList = new ArrayList<>();
        contactList.add("Alpha");
        contactList.add("Beta");
        contactList.add("Gamma");
        contactList.add("Kappa");
        contactList.add("Theta");
        contactList.add("Omega");
        paymentsAdapter = new PaymentsAdapter(this, contactList);
        paymentListView.setAdapter(paymentsAdapter);
